                    ...
                    try (ResultSet result = statement.executeQuery(query)) {
                        ...
                        if (flag != 0) {
                            try (Statement statement1 = conn.createStatement()) {
                                String query1 = "INSERT into login(Name, Contact, Address, Email, City, UserName, Password) VALUES('" + txtuname.getText() + "','" + txtcontact.getText() + "','" + txtAddress.getText() + "','" + txtEmailID.getText() + "','" + txtCity.getText() + "','" + txtUserName.getText() + "','" + txtPassword.getText() + "');";
